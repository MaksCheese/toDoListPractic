...
<div class="text-center mt-5">
    ...
    <form class="row g-3 justify-content-center" method="POST" action="{{route('todos.store')}}">
        @csrf
        <div class="col-6">
            <input type="text" class="form-control" name="title" placeholder="Введите задачу">
        </div>
        <div class="col-auto">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($todo->is_completed)
                                <div class="badge bg-success">Выполнено</div>
                            @else
                                <div class="badge bg-warning">Не выполнено</div>
                            @endif
                        </td>
                        <td>
